...
The package can be referenced through twinBASIC's Package Server. In the IDE, click **References -> Available Packages**. Scroll to find the entry "File System Tools - Modern Replacement for FSO" and click the checkbox on the left of the entry. Then click **Apply Changes** button in lower-right.
